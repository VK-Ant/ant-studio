...
- [Sales Forecasting and Visualization](#sales-forecasting-and-visualization)
- [Document Intelligence](#document-intelligence)
- [Anomaly Detection](#anomaly-detection)
- [Quality and Audit Reports](#quality-and-audit-reports)
- [Pipeline Tracking](#pipeline-tracking)
- [Pipeline Tracker UI](#pipeline-tracker-ui)
- [Docker Compose](#docker)
- [Python SDK](#python-sdk)
- [Input Sources and Output Destinations](#input-sources-and-output-destinations)
- [Responsible AI -- Always On](#responsible-ai----always-on)
- [All Commands](#all-commands)
- [Ant Intelligence Ecosystem](#ant-intelligence-ecosystem)
...
1. Ollama running locally? Use it.
2. API key in environment? Use that provider.
3. No config? Ollama fallback with helpful error message.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/VK-Ant/ant-studio/main/assets/forecast_output.png" alt="Forecast Output" width="90%">
</p>
...
- **Compliance**: attach `_audit.json` to prove data never left the system
- **Debugging**: check `_quality.json` to find which steps scored low
- **CI/CD**: parse JSON in your pipeline to gate deployments on quality thresholds
...
| `ollama` | 11434 | Local LLM server for document Q&A |
...
| Volume | Purpose |
|--------|---------|
| `./data` | Input data (mount your files here) |
| `./output` | Generated outputs (CSVs, charts, reports) |
| `antstudio-runs` | Pipeline run history (persists across restarts) |
...
|---------|--------|---------| ---- |
| [DocQWise](https://pypi.org/project/docqwise/) | Documents | Read. Extract. Retrieve. | ![PyPI](https://img.shields.io/pypi/v/docqwise?style=flat-square) |
| [WavQWise](https://pypi.org/project/wavqwise/) | Temporal | Sense. Forecast. Alert. | ![PyPI](https://img.shields.io/pypi/v/wavqwise?style=flat-square) |
| [SightRAG](https://pypi.org/project/sightrag/) | Vision | See. Search. Retrieve. | ![PyPI](https://img.shields.io/pypi/v/sightrag?style=flat-square) |
| [SonarWise](https://pypi.org/project/sonarwise/) | Audio | Hear. Search. Retrieve. | ![PyPI](https://img.shields.io/pypi/v/sonarwise?style=flat-square) |
| [Adaptive Intelligence](https://pypi.org/project/adaptive-intelligence/) | Routing | Learn. Remember. Adapt. | ![PyPI](https://img.shields.io/pypi/v/adaptive-intelligence?style=flat-square) |
| [llmevalkit](https://pypi.org/project/llmevalkit/) | Quality | Evaluate. Score. Improve. | ![PyPI](https://img.shields.io/pypi/v/llmevalkit?style=flat-square) |
| [AntGuard](https://pypi.org/project/antguard/) | Privacy | Guard. Detect. Protect. | ![PyPI](https://img.shields.io/pypi/v/antguard?style=flat-square) |
...
- [x] CLI with doc extract, doc ask, ts forecast, ts anomaly
- [x] Pipeline tracking with  step visualization
- [x] Production-grade forecast chart output (historical + forecast + confidence interval)
- [x] Backbone: auto quality scoring + privacy auditing on every command
- [x] Docker Compose (CLI + Ollama + Tracker UI)
- [x] Pipeline Tracker web UI with flow graph and run history
- [x] Multi-provider LLM engine (Ollama, OpenAI, Azure, Anthropic, HuggingFace, Groq, Mistral, DeepSeek, local GGUF)
- [x] Quality + audit reports saved as JSON alongside every pipeline output
- [x] Local GGUF model support via llama-cpp-python
...
<p align="center">
  <img src="https://raw.githubusercontent.com/VK-Ant/ant-studio/main/assets/logo.png" alt="Ant Studio" width="100">
  <br>
